  ...
  <Layout>
    <div className="main">
      ...
      <p>
        ...
        <a href="http://eco-calculateur.aviation-civile.gouv.fr/" target="_blank" rel="noopener noreferrer" >
      ...
      <blockquote cite="https://seat61.com">
        <em>
          ...
          <a href="https://seat61.com" target="_blank" rel="noopener noreferrer" >
            seat61.com
          </a>{' '}
      ...
      <p>
        <a href="https://fr.warmshowers.org" target="_blank" rel="noopener noreferrer" >
        ...
        <a href="https://www.heureux-cyclage.org" target="_blank" rel="noopener noreferrer" >
      ...
      <em>
        ...
        <a href="http://www.unep.fr/greenpassport" target="_blank" rel="noopener noreferrer" >
      ...
      <p>
        Cette infographie{' '}
        <a href="http://trademachines.fr/info/eau-en-bouteille" target="_blank" rel="noopener noreferrer" >
      ...
      <blockquote cite="http://ddc.arte.tv/emission/des-oceans-sans-poissons">
        <em>
          ...
          <p>
            ...
            <a href="http://ddc.arte.tv/emission/des-oceans-sans-poissons" target="_blank" rel="noopener noreferrer" >
      ...
      <blockquote cite="https://www.surfrider.eu/">
        <em>
          ...
          <a href="https://www.surfrider.eu/" target="_blank" rel="noopener noreferrer" >
            Surfrider
          </a>{' '}
      ...
      <ul className="dashed">
        <li>
          ...
          <a target="_blank" rel="noopener noreferrer"  href="http://www.unep.fr/greenpassport">
            http://www.unep.fr/greenpassport
          </a>
        </li>
        <li>
          ...
          <ul className="dashed">
            <li>
              ...
              <a target="_blank" rel="noopener noreferrer"  href="http://www.ademe.fr/vacances-kilometre">
        ...
        <li>
          ...
          <a target="_blank" rel="noopener noreferrer"  href="http://www.citepa.org/fr/">
            http://www.citepa.org/fr/
          </a>
        </li>
        <li>
          Association qui milite contre la pollution océanique:{' '}
          <a target="_blank" rel="noopener noreferrer"  href="https://www.surfrider.eu">
            https://www.surfrider.eu
          </a>
        </li>
        <li>
          Association orientée vers la montagne:{' '}
          <a target="_blank" rel="noopener noreferrer"  href="http://www.mountain-riders.org">
        ...
        <li>
          ...
          <a target="_blank" rel="noopener noreferrer"  href="http://trademachines.fr/info/eau-en-bouteille">
            http://trademachines.fr/info/eau-en-bouteille
          </a>
        </li>
        <li>
          Voyage en vélo:{' '}
          <a target="_blank" rel="noopener noreferrer"  href="https://fr.warmshowers.org">
            https://fr.warmshowers.org
          </a>{' '}
          <a target="_blank" rel="noopener noreferrer" href="https://www.heureux-cyclage.org">
            https://www.heureux-cyclage.org
          </a>
        </li>
        <li>
          Voyage en train:{' '}
          <a target="_blank" rel="noopener noreferrer"  href="https://seat61.com">
            seat61.com
          </a>
        </li>
        <li>
      ...
      <p>
        ...
        <a href="https://github.com/superzadeh/voyage-responsable" target="_blank" rel="noopener noreferrer" >
          Github
        </a>
      </p>
      <p>
        Pour toutes suggestions, n'hésitez pas à{' '}
        <a href="https://github.com/superzadeh/voyage-responsable/issues" target="_blank" rel="noopener noreferrer" >
          créer une Issue
        </a>{' '}
        sur Github.
      </p>
